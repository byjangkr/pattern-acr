function [outSpk, outMS, outHS, outW] = run_ls(fluency_data,task_id,gNum,fid)
...
for gNum_test=1:gNum % cross validation
    ...
    % LS���� nomailzing�� feature�� ����ϸ� ȸ�ͺм��� ������ ���ָ� �����ų �� ����
    % Least square
    %w = pinv(or_trainX)*trainD;
    %dv = or_testX*w;     
    mdl = LinearModel.fit(no_trainX,trainD);
    [dv, w] = predict(mdl,no_testX);
